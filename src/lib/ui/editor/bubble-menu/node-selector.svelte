...
<div>
	<div class="relative h-full">
		...
		<div
			use:melt={$content}
			align="start"
			class="animate-in fade-in slide-in-from-top-1 z-[99999] my-1 flex max-h-80 w-48 flex-col overflow-hidden overflow-y-auto rounded border border-stone-200 bg-white p-1 shadow-xl"
		>
